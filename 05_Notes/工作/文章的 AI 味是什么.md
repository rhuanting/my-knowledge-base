...
文章有 AI 味时，语言可以很流畅，结构也可以很清晰，但读者感觉不到一个真实作者在场。
...
对于科研论文、技术报告和知识型文章来说，AI 味最显眼的问题常常是过度无懈可击。它会把所有话说得稳妥、抽象、均衡，却把真实研究中的选择、取舍、卡点和失败擦掉。

## AI 味不能证明文章由 AI 写成

一篇有 AI 味的文章，未必由 AI 生成。

没有任何单一特征可以证明一篇文章来自 ChatGPT、Claude 或 Gemini。很多人类作者也会写出很重的 AI 味，因为他们习惯写标准答案、汇报材料、论文套话和过度安全的中庸表达。

所以，判断 AI 味时，重点看文章里有没有真实思考的痕迹，少纠缠作者身份。
...
这三句话未必错，问题是它们太像“合理答案”，不像某个人真的想说的话。
...
这些词可以用，但如果一句话删掉它们以后信息量没有减少，就说明它们只是填充物。
...
具体数据、地点、年份、设备、参数、样本、阈值、处理平台越清楚，文章越像真实工作记录，也越能摆脱抽象概括。
...
如果每段都靠“此外、同时、然而、因此”往下接，读者会感觉作者没有推进一个问题，只是在拼接一组正确句子。
...
它避开了“未来继续优化”这种泛泛表达，直接指出下一步最需要验证的具体问题。
...
这句话的价值来自它暴露的真实约束：GEE 内存限制影响了方法设计。
...
降低 AI 味，靠的并非把文章改得更口语化，也不靠故意制造错别字和不流畅。
